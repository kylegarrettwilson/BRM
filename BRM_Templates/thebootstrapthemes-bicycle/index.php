...
<!-- header -->
      ...
      <h1 class="logo"><a href="#home" class="scroll">Tucon bicycle</a></h1>
      <div class="menu">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active"><img src="images/banner1.jpg" class="img-responsive">
               <!-- caption -->
              <div class="caption">
              <h2>Smooth Gears</h2>
        ...
        <div class="item"><img src="images/banner2.jpg" class="img-responsive">
               <!-- caption -->
              <div class="caption">
              <h2>Smooth Gears</h2>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        ...
        <div class="item"><img src="images/banner3.jpg" class="img-responsive">
              <!-- caption -->
              <div class="caption">
              <h2>Smooth Gears</h2>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
...
<div class="about" id="about">
  <div class="container">
    <h2 class="text-center">Know what makes us different</h2>
    <div class="row">
    <div class="col-md-6 col-xs-12 col-md-offset-3">
        ...
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
           <i class="fa fa-bicycle"></i> What are the special features
          </a>
        </h4>
        </div>
        ...
        <h4 class="panel-title">
          <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
           <i class="fa fa-bicycle"></i> The record that we have set so far on sales
          </a>
        </h4>
        </div>
        ...
        <h4 class="panel-title">
          <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
           <i class="fa fa-bicycle"></i> Who uses our products most
          </a>
        </h4>
        </div>
        ...
        <h4 class="panel-title">
          <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
           <i class="fa fa-bicycle"></i> Price Ranges
          </a>
        </h4>
        </div>
        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel">
        <div class="panel-body">
           <div class="clearfix food-list"><div class="pull-left">Bicycle</div><span class="pull-right">$ 10.00</span></div>
          <div class="clearfix food-list"><div class="pull-left">Mountains </div><span class="pull-right">$ 10.00</span></div>
          <div class="clearfix food-list"><div class="pull-left">Old Cycle</div><span class="pull-right">$ 10.00</span></div>
          <div class="clearfix food-list"><div class="pull-left">New Brands</div><span class="pull-right">$ 10.00</span></div>
        </div>
        </div>
        </div>
