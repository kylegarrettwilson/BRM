...
<!-- header -->
      ...
      <div class="fullpage">
        ...
        <div class="ab-center">
          ...
          <h1 class="title">Tucon Digital</h1>
          <p>An exciting new website is launching soon<br>
          Sign in to our Newsletter and be the first one to enjoy our project</p>
    ...
    <div class="portfolio">
      <div class="spacer">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active"><img src="images/photos/1.jpg" class="img-responsive"></div>
          <div class="item"><img src="images/photos/2.jpg" class="img-responsive"></div>
          <div class="item"><img src="images/photos/3.jpg" class="img-responsive"></div>
        </div>    
        <!-- Controls -->
